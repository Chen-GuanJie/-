...
=== 实验结果与误差来源
@tbl:widget-detection-accuracy 详细列出了模型在七大控件类别上的检测性能。从总体来看，模型在多样化的公开数据集上达到了 0.515 的 mAP 和 0.588 的 mAR，这一结果展现了令人满意的基准性能，作为对比参考，同类模型在通用的 COCO 数据集上的 mAP 约为 0.502 @ultralytics-yolov8。这表明经过 GUI 领域数据微调的模型已具备理解复杂应用界面的基本能力。
#tablex(
  ...
  label-name: "widget-detection-accuracy",
)
